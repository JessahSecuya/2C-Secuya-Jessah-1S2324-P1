...
public class MainActivity1 {
    public static void main(String[] args) {
        ...
        transportation1.setTypeOfTransportation("Sea");
        ...
        //Object 2
        Transportation transportation2 = new Transportation("Land", "Bus", "Daanbantayan to Cebu");
        transportation2.display(2);

        //Object 3
        Transportation transportation3 = new Transportation("Land", "Tricycle", "Kawit to Medellin");
        //Updating the parameters
        transportation3.setTypeOfTransportation("Air");
